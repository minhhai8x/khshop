...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { catid: @admin_product.catid, description: @admin_product.description, image: @admin_product.image, name: @admin_product.name, price: @admin_product.price }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { catid: @admin_product.catid, description: @admin_product.description, image: @admin_product.image, name: @admin_product.name, price: @admin_product.price }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
