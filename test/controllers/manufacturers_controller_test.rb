...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { address: @manufacturer.address, name: @manufacturer.name, phone: @manufacturer.phone, status: @manufacturer.status }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { address: @manufacturer.address, name: @manufacturer.name, phone: @manufacturer.phone, status: @manufacturer.status }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
